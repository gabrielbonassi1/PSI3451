...
add wave -noupdate -label BUTTON_SPEED -radix decimal /tb_wisdom/sys_speed_s
...
add wave -noupdate -group MEM -label MEM_ADDR_A(signal) -radix unsigned /tb_wisdom/dut/cir1/mem/address_a
add wave -noupdate -group MEM -label MEM_ADDR_B(signal) -radix unsigned /tb_wisdom/dut/cir1/mem/address_b
...
WaveRestoreCursors {{Cursor 1} {537630150 ps} 0}
...
update
WaveRestoreZoom {537118150 ps} {538142150 ps}
